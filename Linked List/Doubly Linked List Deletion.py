...
class LinkedList:
    ...
    def delete_node(self,node):
        if self.head is None or node is None:
            return
        if self.head ==  node:                                                                                  #First Node
            self.head = node.next_node
            self.head.prev_node = None
            return        
        if node.next_node is None:                                                                              #Last Node
            node.prev_node.next_node = None
            return
        node.prev_node.next_node = node.next_node                                                               #In middle of two nodes
...
LL.printLinkedList()
LL.delete_node(LL.head.next_node)
LL.printLinkedList()
